...
function printDashboard($pageid)
{
	...
	if (($_SESSION['DM1-team']== -1  || $_SESSION['DM1-username'] == "sgiordano" || $_SESSION['DM1-username'] == "mgerstman") && $pageid!=4)
	{
		echo('<a href ="admin.php">Admin</a>&nbsp;|&nbsp;');
	}
	else if ($usertype && $pageid!=2 && $pageid!=4)
	{//only give access to the overall panel to overalls
		echo('<a href ="overall.php?team='.$_SESSION['DM1-team'].'">Overall Panel</a>&nbsp;|&nbsp;');
	}
	...
	if (($_SESSION['DM1-username'] == "mgerstman") || ($_SESSION['DM1-username'] == "sgiordano"))
	{
