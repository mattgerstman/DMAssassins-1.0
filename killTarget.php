...
The Assassins Staff";
	...
	{
		tweet("@CurlyQT202 Chrissy McLarty died after trying to stop a modern-day caveman from climbing out a 9 story window. #RCB #YOUDONTEVENKNOW");
	}
...
{
	$_SESSION['DM1-status'] = "<p><strong>Error:</strong> That is not your targets pin.<br/><br/> If you think they're a lying cheat,<br /> their overall can kill them manually. <br /> Or maybe you messed up, who knows?</p>";
	echo('<SCRIPT LANGUAGE="JavaScript">redirURL = "index.php"; self.location.href = redirURL;</script>');
}
