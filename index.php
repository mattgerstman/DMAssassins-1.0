...
//	if (false)
	{
		...
		echo("<p class='special'>Got an idea for the <a href='http://www.twitter.com/DMAssassins'>DMAssassins</a> feed? Submit tweet ideas <a href='/waysYouCanDie.php'>here</a>.</p><br />");
...
//		echo("<br />The game will begin on Monday, November 28, 2011.<br /> You will receive an email when your target has been assigned.");
		echo("<br />Plot twist. We're reassigning targets, brb.");
	}
	else
	{
